...
I implemented the hidden function `assembly:::.modules()` to return the number of modules of the food web. This uses the fast-greedy clustering algorithm of _igraph_:
